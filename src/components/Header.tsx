            ...
            <div tw="container max-w-7xl flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
                ...
                <div tw="flex justify-center flex-1 lg:mr-32">
                    <div tw="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
                        ...
                        <input
                            tw="w-full py-2 pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md leading-5 outline-none dark:(placeholder-gray-500 bg-gray-700 text-gray-200) focus:(placeholder-gray-500 bg-white border-purple-300 ring-purple-100 ring) dark:focus:!ring-gray-500 dark:focus:!bg-gray-700"
                            type="text"
